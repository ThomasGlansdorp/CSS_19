...
class CA_rules:
    ...
    def __init__(self, ca_grid: CA_grid, pbw, pbwl= 0.45, pbl=0.1, pbw_parameter=True, pbl_parameter=True, pbwl_parameter=True) -> None:
    ...
    def generate_simulation(self, pbw):
        self.pbw = pbw
