...
def calculate_attributes(grid=None, rules=None, cell_type=2):
    ...
    fraction_solutes = np.sum(rules.grid == 2) 

    # f_o = unbound_count / total_molecules if total_molecules else 0
    f_o_solute = unbound_count 
    ...
    return f_o_solute, f_1, f_2, f_3, f_4
